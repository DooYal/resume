(() => {
  const translations = {
    ...
    'nav.now': { zh: '2023–2026', en: '2023–2026' },
    ...
    'detail.now.meta': { zh: '2023.08 - 2026.08 · 广州医科大学', en: '2023.08 - 2026.08 · Guangzhou Medical University' },
  ...
  const pageMeta = {
    ...
    '2023-now.html': {
      title: { zh: '2023–2026｜临床多组学与平台开发｜李都悦', en: '2023–2026 | Clinical multi-omics and platform development | Douyue Li' },
